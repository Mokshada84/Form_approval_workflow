...
export const USERS: User[] = [
  ...
  { id: 'emp-1', name: 'Dan Okafor', email: 'dan.okafor@example.com', role: 'Employee' },
  { id: 'emp-2', name: 'Sam Ellis', email: 'sam.ellis@example.com', role: 'Employee' },
  { id: 'emp-3', name: 'Aisha Khan', email: 'aisha.khan@example.com', role: 'Employee' },
  { id: 'emp-4', name: 'Marco Silva', email: 'marco.silva@example.com', role: 'Employee' },
  { id: 'emp-5', name: 'Yuki Tanaka', email: 'yuki.tanaka@example.com', role: 'Employee' },
  ...
  { id: 'mgr-1', name: 'Priya Sharma', email: 'priya.sharma@example.com', role: 'Manager' },
  { id: 'mgr-2', name: 'Tom Becker', email: 'tom.becker@example.com', role: 'Manager' },
  { id: 'mgr-3', name: 'Grace Mwangi', email: 'grace.mwangi@example.com', role: 'Manager' },
  { id: 'mgr-4', name: 'Ivan Petrov', email: 'ivan.petrov@example.com', role: 'Manager' },
  { id: 'mgr-5', name: 'Laura Estevez', email: 'laura.estevez@example.com', role: 'Manager' },

  // --- Senior Managers: the second stage, only on forms above $1,000. ---
  { id: 'snr-1', name: 'Mei Tan', email: 'mei.tan@example.com', role: 'Senior Manager' },
  { id: 'snr-2', name: 'Alex Reid', email: 'alex.reid@example.com', role: 'Senior Manager' },
  { id: 'snr-3', name: 'Omar Haddad', email: 'omar.haddad@example.com', role: 'Senior Manager' },
  { id: 'snr-4', name: 'Hannah Kruger', email: 'hannah.kruger@example.com', role: 'Senior Manager' },
  { id: 'snr-5', name: 'Rajiv Menon', email: 'rajiv.menon@example.com', role: 'Senior Manager' },
]
